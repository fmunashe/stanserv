    ...
    <table class="w-full">
        <tr>
            ...
            <td class="w-quarter">
                ...
                <div><h4><u>Totaliser Readings</u></h4></div>
                <table class="w-full">
                    <tr>
...
<div class="margin-top">
    <h4><u>Calibration Method Used</u></h4>
    <p>{{$record->calibration_method??null}}</p>
</div>
<div class="margin-top">
    <h4><u>Test Measure Details</u></h4>
    <table class="w-full">
        <tr>
            <td class="w-quarter"><strong>Standard</strong></td>
            <td class="w-quarter"><strong>Serial Number</strong></td>
            <td class="w-quarter"><strong>Material of Construction</strong></td>
        </tr>
        <tr>
...
<div class="margin-top">
    <h4>20000 & 5000 M/Litre Assized Test Measure</h4>
</div>
